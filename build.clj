...
(def ^:private pom-template
  [[:description "Provides Portal launcher based on Cljfx's own webrowser component"]
   ...
   [:scm
    [:url "https://github.com/lukaszkorecki/portal.browser.cljfx"]
    [:connection "scm:git:git://github.com/lukaszkorecki/portal.browser.cljfx.git"]
    [:developerConnection "scm:git:ssh://git@github.com/lukaszkorecki/portal.browser.cljfx.git"]]])
